...
public:
    ...
    inline Matrix4::XMFLOAT3 GetForwardVector(float rx = 0.0f, float ry = 0.0f, float rz = 0.0f) const {
      ...
      XMMATRIX vm = mat.transpose().getDXMatrix();

      XMFLOAT3 forward;

      forward.x = -XMVectorGetX((vm.r[2]));
      forward.y = -XMVectorGetY((vm.r[2]));
      forward.z = -XMVectorGetZ((vm.r[2]));
    ...
    inline Matrix4::XMFLOAT3 GetUpVector(float rx = 0.0f, float ry = 0.0f, float rz = 0.0f) const {
      ...
      up.x = -XMVectorGetX((vm.r[1]));
      up.y = -XMVectorGetY((vm.r[1]));
      up.z = -XMVectorGetZ((vm.r[1]));
...
inline Matrix4::Matrix4(XMMATRIX matrix)
{
  set(XMVectorGetX(matrix.r[0]), XMVectorGetX(matrix.r[1]), XMVectorGetX(matrix.r[2]), XMVectorGetX(matrix.r[3]),
      XMVectorGetY(matrix.r[0]), XMVectorGetY(matrix.r[1]), XMVectorGetY(matrix.r[2]), XMVectorGetY(matrix.r[3]), 
      XMVectorGetZ(matrix.r[0]), XMVectorGetZ(matrix.r[1]), XMVectorGetZ(matrix.r[2]), XMVectorGetZ(matrix.r[3]),
...
inline XMMATRIX Matrix4::getDXMatrix() {
  return XMMATRIX(
    m[0], m[4], m[8], m[12],
    m[1], m[5], m[9], m[13],
    m[2], m[6], m[10], m[14],
